---
title: "Lab 2 - tidycensus and RStudio (Part 1)"
format: html
---
...
Please do the R work in R Quarto. Your Rmd file will be generated. Save this file as a PDF (or print to PDF) and **turn in the PDF file(s) and the Rmd file(s)**.

Work through Chapters 1 through 4 of *Analyzing US Census Data*. Use an Rmd file to keep track of your progress.

At the beginning of the Rmd file, use Quarto formatting to answer these questions:
