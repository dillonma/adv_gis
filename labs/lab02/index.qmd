...
[Notes for lab 2](/labs/lab02/week2.qmd).
...
Work through Chapters 1 through 3 of *Analyzing US Census Data*. Use an Qmd (Quarto) file to keep track of your progress.

Pick any single map from the chapters and use Overpass Turbo to create a map in QGIS, adding the exported data from Overpass Turbo and make a map that you're proud of.
